...
const Index = () => {
    ...
    const showImage = (item) => {
        if (item.img !== undefined) {
            ...
            if (item.img === "") {
                imgPath = "default_image.png"
            };
            return <img className='card-img-top' height='180px' src={imgPath} alt='' />
        }
        return <></>;
    }
    ...
    const fetchDataFromLocal = () => {
        ...
        if (itemInCarts !== null) {
            ...
            setRecordInCarts(itemInCarts ? itemInCarts.length : 0);
        ...
        <MyModal id='modalCart' title='ตะกร้าสินค้าของฉัน'>
            ...
            <div className='mt3'>
                <div className='alert alert-info'>
                    ...
                    <div>ไทยพาณิชย์ นาย ปริญวัฒน์ 206-264-9096</div>
                </div>
                <div className='mt-3'>
                    <div>ชื่อผู้ซื้อ</div>
